          ...
          <section id="workshops" className="scroll-mt-24">
            <div className="mb-6">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Pick a workshop and build something you can demo —
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {[
                ...
                >
                  ...
                  <a
                    href={w.href}
                    className="mt-4 inline-block font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
                  >
                    Start Workshop →
                  </a>
                </div>
          ...
          <section id="episodes" className="scroll-mt-24">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={e.num}
                  className="flex items-start gap-4 rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800"
                >
                  <button
                    type="button"
                    className="mt-1 flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 text-gray-900 dark:border-gray-600 dark:text-gray-100"
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                ...
                >
                  ...
                  <a
                    href="/tutorials"
                    className="mt-3 inline-block text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
                  >
                    Guide →
                  </a>
                </div>
          ...
          <section id="contact" className="scroll-mt-24">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="space-y-3 text-gray-600 dark:text-gray-400">
                  {[
                    [
                      ...
                      "No. Many workshops are beginner-friendly and focus on tools first.",
                    ],
                    [
                      "How do workshops work?",
                      "Watch a short episode, follow along, then bring questions to meetings/office hours.",
                    ],
                    [
                      "What do I put on my resume?",
                      "Your deliverable, the tools used, and the impact. We provide a resume bullet template.",
                    ],
                    [
                      "Can I join mid-semester?",
                      "Yes — workshops are designed to be modular so you can jump in anytime.",
                    ],
                    [
                      "How do I get help?",
                      "Use the question form and bring issues to weekly help time at meetings.",
                    ],
                    [
                      "What tools do I need?",
                      "A laptop + free accounts for common tools (ChatGPT, GitHub, etc.).",
                    ],
                  ].map(([q, a]) => (
                    <div
                      key={q}
              ...
              <div className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                ...
                <div className="space-y-3">
                  <input
                    className="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                    placeholder="Name"
                  />
                  <input
                    className="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    (We can connect this to Google Forms/Formspree later — this
                    is a visual mock for now.)
                  </p>
                </div>
